      ...
      <div style={{ display: 'flex', gap: '12px', marginBottom: '24px', flexWrap: 'wrap' }}>
        ...
        >
          {STATUS_OPTIONS.map((opt) => (
            <option key={opt.value} value={opt.value} style={{ background: '#1c1c1a' }}>
              {opt.label}
            </option>
          ))}
        </select>
              ...
              {filtered.map((apt, i) => (
                ...
                >
                  ...
                  <td style={{ padding: '12px 16px' }}>
                    ...
                    >
                      <option value="bekliyor" style={{ background: '#1c1c1a' }}>Bekliyor</option>
                      <option value="onaylandi" style={{ background: '#1c1c1a' }}>Onaylandı</option>
                      <option value="tamamlandi" style={{ background: '#1c1c1a' }}>Tamamlandı</option>
                      <option value="iptal" style={{ background: '#1c1c1a' }}>İptal</option>
                    </select>
                  </td>
                </tr>
              ))}
