...
const SERVICE_COLORS = ['#c49a4a', '#e8c06a', '#5a5850', '#303030', '#242422']
...
const tooltipStyle = {
  ...
  labelStyle: { color: '#5a5850', fontSize: '10px' },
          ...
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={revenueData} margin={{ top: 4, right: 16, left: 0, bottom: 0 }}>
              ...
              <Area
                ...
                dot={false}
                activeDot={{ r: 4, fill: '#c49a4a', stroke: '#0c0c0b', strokeWidth: 2 }}
              />
            </AreaChart>
          </ResponsiveContainer>
        </div>
